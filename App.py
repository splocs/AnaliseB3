...
def exibir_info_empresa(info):
    ...
    st.write(f'**<span title="O risco geral refere-se à probabilidade de que uma ação resultará em perdas, considerando fatores como volatilidade do mercado, desempenho financeiro da empresa e condições econômicas gerais.">Risco Geral:</span>** {info.get("overallRisk", "N/A")}', unsafe_allow_html=True)
